	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<p>
					Posted on <span id="detail_date"></span>
				</p>

				<hr>

				<div id="detail_content" class="my-5"></div>
					...
					<div class="card-body">
						<form>
							<div class="form-group">
								<input type="text" class="form-control" id="comment_user_text"
							...
							<button type="submit" class="btn btn-primary"
								id="create_comment_btn">Write Comment</button>
						</form>
					</div>
				</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							<label for="modify_title_text">Title</label> <input type="text"
								class="form-control" id="modify_title_text" placeholder="Title">
						</div>
						<div class="form-group">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="modify_post_btn">Modify
						Post</button>
				</div>
			</div>
		</div>
